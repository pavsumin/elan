...
const timeline = [
	{
		...
		title: 'The Beginning',
		description:
			'Founded in a small Parisian atelier with a vision of creating timeless, sustainable fashion.',
	},
	{
		year: '2008',
		title: 'Global Expansion',
		description:
			'Opened our first international boutiques in London, New York, and Tokyo.',
	},
	{
		year: '2015',
		title: 'Sustainable Commitment',
		description:
			'Achieved 100% sustainable materials sourcing and carbon-neutral production.',
	},
	{
		year: '2020',
		title: 'Digital Innovation',
		description:
			'Launched our digital-first approach, bringing the boutique experience online.',
	},
	{
		year: '2026',
		title: '25 Years of Craft',
		description:
			'Celebrating a quarter century of timeless elegance and sustainable luxury.',
	},
]
...
const values = [
	{
		...
		description:
			'Every piece is designed to transcend seasons, becoming a lasting part of your wardrobe.',
	},
	{
		number: '02',
	...
	},
	{
		...
		description:
			'Only the finest organic and sustainably sourced fabrics meet our exacting standards.',
	},
	{
		number: '04',
		title: 'Enduring Quality',
		description:
			'Crafted to be worn, loved, and passed down through generations.',
	},
]
	...
	return (
		<>
			...
			<main className='min-h-screen bg-background pt-18'>
						...
						<div className='grid gap-12 lg:grid-cols-2 lg:gap-20'>
							...
							>
								<p className='text-sm leading-relaxed text-muted-foreground'>
									In a world of fast fashion and fleeting trends, ÉLAN stands as
									a beacon of intentional design and sustainable luxury. Founded
									by Marie Laurent in 2001, our maison has dedicated over two
									decades to crafting pieces that transcend seasons and speak to
									the timeless in all of us.
								</p>
								<p className='text-sm leading-relaxed text-muted-foreground'>
									Every garment that bears our name begins with a simple
									question: will this piece be loved and worn for years to come?
									This guiding principle informs every decision we make, from
									the materials we source to the artisans we partner with.
								</p>
								<p className='text-sm leading-relaxed text-muted-foreground'>
									Our commitment to sustainability is not a marketing
									strategy—it is the foundation upon which our entire philosophy
									rests. True luxury, we believe, lies not in excess but in the
						...
						<div className='grid gap-12 lg:grid-cols-2 lg:gap-20'>
							...
							>
								...
								<p className='mt-8 text-sm leading-relaxed text-muted-foreground'>
									With over 30 years in the fashion industry, Marie brings a
									unique perspective that balances artistry with responsibility.
									Her vision continues to guide ÉLAN toward a future where
									luxury and sustainability are inseparable.
								</p>
							</motion.div>
						</div>
					</div>
				...
				{/* Values */}
				<section
					className='bg-foreground px-6 py-24 text-primary-foreground md:px-12 md:py-32 lg:px-20'
					ref={valuesRef}
				>
					<div className='mx-auto max-w-7xl'>
						<motion.div
					...
					<div className='mx-auto max-w-7xl'>
						<div className='grid gap-12 lg:grid-cols-2 lg:gap-20'>
							...
							>
								...
								<p className='mt-8 text-sm leading-relaxed text-muted-foreground'>
									Our atelier brings together master craftspeople from across
									Europe, each bringing generations of expertise to their work.
									From pattern cutting to final finishing, every step is
									performed by hand with meticulous attention to detail.
								</p>
								<p className='mt-6 text-sm leading-relaxed text-muted-foreground'>
									We believe in preserving traditional techniques while
									embracing innovation that serves our commitment to
									sustainability. The result is garments that embody the best of
									both worlds—timeless craftsmanship with a conscience.
								</p>
								<Link
									href='/collections'
