              ...
              <div className="lg:py-8">
                  ...
                  <div className="mt-3 flex gap-3">
                    {product.colors.map((color) => (
                      ...
                      >
                        ...
                        />
                        {selectedColor === color && (
                          <Check className="absolute inset-0 m-auto h-4 w-4 text-foreground mix-blend-difference" strokeWidth={2} />
                        )}
                      </button>
                    ))}
                  </div>
                ...
                <div className="mt-8">
                  <div className="flex items-center justify-between">
                    <p className="text-xs tracking-[0.15em] text-muted-foreground">SELECT SIZE</p>
                ...
                {/* Quantity */}
                <div className="mt-8">
                  <p className="text-xs tracking-[0.15em] text-muted-foreground">QUANTITY</p>
                ...
                <div className="mt-12 space-y-0 divide-y divide-border border-t border-border">
                  ...
                  <details className="group py-4">
                    ...
                    <p className="mt-4 text-sm text-muted-foreground">{product.care}</p>
                  </details>
                  <details className="group py-4">
                    <summary className="flex cursor-pointer items-center justify-between text-xs tracking-[0.15em]">
                      SHIPPING & RETURNS
