  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background pt-20">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="mt-6 max-w-xl text-sm leading-relaxed text-muted-foreground">
                Explore our world through stories of craft, sustainability, and the 
                art of mindful dressing. Discover the people and processes behind 
                every piece.
              </p>
            </motion.div>
          </div>
        ...
        {/* Posts Grid */}
        <section className="bg-card px-6 py-16 md:px-12 md:py-24 lg:px-20" ref={gridRef}>
          <div className="mx-auto max-w-7xl">
