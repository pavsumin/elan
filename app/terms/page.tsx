					...
					<div className='mx-auto max-w-3xl'>
						...
						<div className='mt-12 space-y-12 text-sm leading-relaxed text-muted-foreground'>
							...
							<section>
								...
								<p>
									All products displayed on this website are subject to
									availability. We reserve the right to discontinue any product
									at any time. Prices for products are subject to change without
							...
							<section>
								...
								<p>
									...
									purchased per person, per household, or per order. Payment
									must be received prior to the acceptance of an order.
								</p>
							</section>
							...
							<section>
								...
								<p>
									Shipping times are estimates only and cannot be guaranteed. We
									are not liable for any delays in shipments. Risk of loss and
									title for items purchased pass to you upon delivery of the
							...
							<section>
								...
								<p>
									...
									in original condition with tags attached. Items marked as
									final sale cannot be returned or exchanged. Refunds will be
							...
							<section>
								...
								<p>
									...
									of ÉLAN and is protected by international copyright laws. You
							...
							<section>
								...
								<p>
									In no event shall ÉLAN, its directors, employees, or agents be
									liable for any indirect, punitive, incidental, special, or
									consequential damages arising out of or in any way connected
									with the use of this website or products purchased through it.
								</p>
							</section>
