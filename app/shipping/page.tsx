						...
						<div className='mt-12 space-y-12 text-sm leading-relaxed text-muted-foreground'>
							...
							<section>
								...
								<p>
									...
									rates are calculated at checkout based on destination and
									package weight. Delivery times typically range from 7-14
									business days.
								</p>
								<p className='mt-4'>
							...
							<section>
								...
								<p>
									Orders placed before 2pm EST Monday-Friday are typically
									processed the same day. Orders placed after 2pm EST or on
							...
							<section>
								...
								<p>
									...
									tracking number. You can track your package by visiting our
									website or the carrier&apos;s tracking page.
								</p>
							</section>
