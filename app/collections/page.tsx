...
import { SlidersHorizontal, Grid3X3, LayoutGrid, Plus } from "lucide-react"
          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="mt-6 max-w-xl text-sm leading-relaxed text-muted-foreground">
                Discover our curated selection of refined essentials, each piece crafted 
                with uncompromising attention to detail and the finest natural materials.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between">
              ...
              <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                ...
                <SheetContent side="bottom" className="h-[70vh] bg-background">
                  <SheetHeader className="border-b border-border pb-4">
                    <SheetTitle className="text-xs tracking-[0.15em]">FILTER & SORT</SheetTitle>
                  </SheetHeader>
                  <div className="py-6 px-6">
                    <div className="mb-8">
                      <h3 className="mb-4 text-xs tracking-[0.15em] text-muted-foreground">CATEGORY</h3>
                    ...
                    <div>
                      <h3 className="mb-4 text-xs tracking-[0.15em] text-muted-foreground">SORT BY</h3>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="hidden items-center gap-2 lg:flex">
                  <span className="text-xs tracking-[0.1em] text-muted-foreground">SORT:</span>
