...
export default function CheckoutPage() {
      ...
      <>
        ...
        <main className="flex min-h-screen items-center justify-center bg-background pt-20">
          <div className="text-center">
            ...
            <p className="mt-4 text-muted-foreground">Add some items to proceed to checkout.</p>
            <Button asChild className="mt-6 bg-foreground text-primary-foreground hover:bg-foreground/90">
  ...
  if (step === "success") {
    return (
      <>
        <Header />
        <main className="flex min-h-screen items-center justify-center bg-background pt-20 px-6">
          <motion.div
          ...
          >
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center bg-foreground">
              <Check className="h-10 w-10 text-primary-foreground" strokeWidth={1.5} />
            </div>
            ...
            <p className="mt-2 font-serif text-lg">Order #EL{Math.random().toString().slice(2, 8)}</p>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 flex items-center gap-4">
              <div className={`flex items-center gap-2 ${step === "info" ? "text-foreground" : "text-muted-foreground"}`}>
                <div className={`flex h-6 w-6 items-center justify-center text-xs ${step === "info" ? "bg-foreground text-primary-foreground" : "border border-current"}`}>
              ...
              <div className={`flex items-center gap-2 ${step === "payment" ? "text-foreground" : "text-muted-foreground"}`}>
                <div className={`flex h-6 w-6 items-center justify-center text-xs ${step === "payment" ? "bg-foreground text-primary-foreground" : "border border-current"}`}>
                  2
                </div>
              ...
              <div>
                {step === "info" && (
                  ...
                  >
                    ...
                    <div>
                      <h2 className="text-xs tracking-[0.15em]">SHIPPING ADDRESS</h2>
                      <div className="mt-4 grid gap-4 sm:grid-cols-2">
                        <div>
                          <label className="mb-2 block text-xs text-muted-foreground">FIRST NAME</label>
                          <Input
                            required
                        ...
                        <div>
                          <label className="mb-2 block text-xs text-muted-foreground">LAST NAME</label>
                          <Input
                            required
                      ...
                      <div className="mt-4 grid gap-4 sm:grid-cols-3">
                        <div>
                          <label className="mb-2 block text-xs text-muted-foreground">CITY</label>
                          <Input
                            required
                            value={formData.city}
                        ...
                        <div>
                          <label className="mb-2 block text-xs text-muted-foreground">STATE</label>
                          <Input
                            required
                        ...
                        <div>
                          <label className="mb-2 block text-xs text-muted-foreground">ZIP CODE</label>
                          <Input
                            required
                            value={formData.zip}
                      ...
                      <div className="mt-4">
                        <label className="mb-2 block text-xs text-muted-foreground">COUNTRY</label>
                    ...
                    <Button type="submit" className="w-full bg-foreground py-6 text-xs tracking-[0.15em] text-primary-foreground hover:bg-foreground/90">
                      CONTINUE TO PAYMENT
                    </Button>
                  </motion.form>
                )}
                    ...
                    <div>
                      ...
                      <div className="mt-6 border border-border p-6">
                        ...
                        <div className="mt-6 space-y-4">
                          <div>
                            <label className="mb-2 block text-xs text-muted-foreground">CARD NUMBER</label>
                            <Input
                              required
                          ...
                          <div>
                            <label className="mb-2 block text-xs text-muted-foreground">NAME ON CARD</label>
                            <Input
                              required
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <label className="mb-2 block text-xs text-muted-foreground">EXPIRY</label>
                              <Input
                                required
                                placeholder="MM/YY"
                            ...
                            <div>
                              <label className="mb-2 block text-xs text-muted-foreground">CVC</label>
                              <Input
                                required
                                placeholder="123"
                                type="password"
