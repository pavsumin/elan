        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mt-8 max-w-md text-sm leading-relaxed text-primary-foreground/80">
              ...
              refined elegance. Our style consultants are ready to help you 
              find pieces that perfectly complement your personal aesthetic.
            </p>
            ...
            <div className="mt-16 grid gap-8 border-t border-primary-foreground/20 pt-8 sm:grid-cols-2">
              <div>
                <p className="text-xs tracking-[0.15em] text-primary-foreground/60">FLAGSHIP STORE</p>
              ...
              <div>
                <p className="text-xs tracking-[0.15em] text-primary-foreground/60">OPENING HOURS</p>
                <p className="mt-2 text-sm text-primary-foreground">
                  Mon - Sat: 10am - 7pm<br />
                  Sunday: 12pm - 6pm
                </p>
