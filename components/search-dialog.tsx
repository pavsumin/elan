        ...
        <div className="max-h-[60vh] overflow-y-auto p-6">
          {!query.trim() ? (
            <div className="py-12 text-center">
              ...
              <div className="mt-6">
                <p className="text-xs tracking-[0.15em] text-muted-foreground">POPULAR SEARCHES</p>
                <div className="mt-3 flex flex-wrap justify-center gap-2">
                  {["Linen", "Cashmere", "New Arrivals", "Sustainability"].map((term) => (
                    <button
                      key={term}
            ...
            <div className="py-12 text-center">
              ...
              <p className="mt-2 text-xs text-muted-foreground">Try searching for something else</p>
            </div>
          ) : (
            <div className="space-y-8">
              ...
              {results.products.length > 0 && (
                <div>
                  <div className="mb-4 flex items-center justify-between">
                    <h3 className="text-xs tracking-[0.15em] text-muted-foreground">PRODUCTS</h3>
                    <Link
              ...
              {results.articles.length > 0 && (
                <div>
                  <div className="mb-4 flex items-center justify-between">
                    <h3 className="text-xs tracking-[0.15em] text-muted-foreground">JOURNAL</h3>
                    <Link
                      href="/journal"
                      onClick={() => onOpenChange(false)}
                      className="text-xs underline underline-offset-4"
                  ...
                  <div className="space-y-4">
                    {results.articles.map((article) => (
                      ...
                      >
                        ...
                        <p className="mt-1 text-sm group-hover:underline">{article.title}</p>
                      </Link>
                    ))}
                  </div>
                </div>
