...
export function Header({ variant = "dark", forceScrolled = false }: HeaderProps) {
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 md:px-12 lg:px-20">
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  pathname === item.href
                    ? showDark ? "text-foreground" : "text-primary-foreground"
                    : showDark ? "text-muted-foreground hover:text-foreground" : "text-primary-foreground/70 hover:text-primary-foreground"
                )}
              >
                {item.name}
                {pathname === item.href && (
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  showDark ? "bg-foreground text-primary-foreground" : "bg-primary-foreground text-foreground"
                )}
              >
                {totalItems}
              </span>
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-full bg-background p-0 sm:max-w-md">
                <SheetTitle className="sr-only">Navigation Menu</SheetTitle>
                <div className="flex h-full flex-col">
                  <div className="flex items-center justify-between border-b border-border px-6 py-5">
                    <span className="font-serif text-2xl tracking-[0.2em]">ÉLAN</span>
                    <SheetClose asChild>
